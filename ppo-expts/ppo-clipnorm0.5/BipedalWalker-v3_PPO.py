...
class Actor_Model:
    def __init__(self, input_shape, action_space, lr, optimizer):
        ...
        self.Actor.compile(loss=self.ppo_loss_continuous, optimizer=optimizer(lr=lr, clipnorm=0.5))
...
class Critic_Model:
    def __init__(self, input_shape, action_space, lr, optimizer):
        ...
        self.Critic.compile(loss=[self.critic_PPO2_loss(old_values)], optimizer=optimizer(lr=lr, clipnorm=0.5))
